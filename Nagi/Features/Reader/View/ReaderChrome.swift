...
final class ReaderTransitionCoordinator {
    ...
    /// Covers mutations that can expose an intermediate surface.
    func begin(kind: ReaderVisualMutationKind, reduceMotion: Bool) {
        ...
        // Start with a solid cover because WKWebView snapshots can be nil.
    ...
    /// Finishes the cover after the model and visible content settle.
