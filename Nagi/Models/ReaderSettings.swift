...
/// Colors used by the reader surface and settings preview.
...
/// Fixed font choices shared by the settings UI and Readium.
enum ReaderFontFamily: String, CaseIterable, Hashable, Identifiable, Codable, Sendable {
    ...
    /// UIKit face-name aliases used by the preview and fallback path.
    ...
    /// CSS names registered by the EPUB navigator.
